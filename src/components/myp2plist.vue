        ...
        <el-dialog title="添加平台用户" :visible.sync="addmyp2p" width="450px" :before-close="handleClose" >
            <el-form :model="addmyp2p_form" :label-position="labelPosition" label-width="100px" >
                <el-form-item label="平台名称">
                    <el-select clearable class="filter-item"  v-model="addmyp2p_form.p2p_id" placeholder="请选择平台名称" style="width:320px">
...
export default {
    ...
    methods: {
        ...
        addmyp2p_fun() {
            console.log(this.addmyp2p_form.p2p_id)
            var p2p_id=this.addmyp2p_form.p2p_id
            console.log(this.addmyp2p_form.account)
